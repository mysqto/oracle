    ...
    async def help_handler(update: Update, _: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        await update.message.reply_markdown_v2(
            text=prefix + f"```bash\n"
                          ...
                          f"change instance ip address\n"
                          f"/delete\\_ipv6     \\<profile\\> \\<instance_name\\> \\[ipv6_address\\] \\- "
                          f"delete ipv6 address\n"
                          f"/rename\\_instance \\<profile\\> \\<old_name\\> \\<new_name\\> \\- rename instance\n"
                          f"/create\\_instance \\<profile\\> \\<shape\\> \\<instance_config\\> "
                          f"\\[use\\_master\\_ssh\\_key\\] \\- create instance\n"
                          f"/resize\\_instance \\<profile\\> \\<instance\\_name\\> \\<shape_config\\> \\- "
                          f"resize instance\n"
                          f"/delete\\_instance \\<profile\\> \\<instance\\_name\\> \\- delete instance\n"
                          f"/start\\_instance  \\<profile\\> \\<instance\\_name\\> \\- start instance\n"
                          f"/instance\\_action \\<profile\\> \\<instance\\_name\\> \\<action\\> \\- instance action\n"
